...
# Training window for ARIMA-family models (~1 year of 15-min data)
ARIMA_TRAIN_ROWS = 35040

# Walk-forward validation hold-out
ARIMA_VAL_DAYS = 7
ARIMA_VAL_STEPS = ARIMA_VAL_DAYS * 96

# ARIMA(p,d,q) — pure univariate baseline (no exogenous, no season)
ARIMA_ORDER = (2, 0, 2)

# ARIMAX(p,d,q) — same order but with exogenous regressors
ARIMAX_ORDER = (2, 0, 2)

# SARIMA(p,d,q)x(P,D,Q,m) — seasonal model; m=96 = one full day
SARIMA_ORDER = (1, 0, 1)
SARIMA_SEASONAL_ORDER = (1, 1, 1, 96)

# Fourier harmonics for daily/weekly seasonality
ARIMA_DAILY_HARMONICS = 3          # sin/cos pairs for 24-h cycle
ARIMA_WEEKLY_HARMONICS = 2         # sin/cos pairs for 7-day cycle
